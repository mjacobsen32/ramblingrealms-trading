...
class ETradeSecrets(BaseModel):
    ...
    """
    api_secret: SecretStr = Field(default=SecretStr(""), description="E-Trade API Secret")
    api_key: SecretStr = Field(default=SecretStr(""), description="E-Trade API")
    oauth_token: SecretStr = Field(default=SecretStr(""), description="E-Trade OAuth Token")
    oauth_token_secret: SecretStr = Field(
        default=SecretStr(""), description="E-Trade OAuth Token Secret"
    )

    @field_serializer('api_secret', 'api_key', 'oauth_token', 'oauth_token_secret', when_used='json')

...
def setup():
    ...
    if etrade.lower() == "y":
        ...
        etrade_authenticate = Prompt.ask("Do you want to authenticate E-Trade now?", default="n")
    ...
    if polygon.lower() == "y":
        # Polygon setup
        user.polygon_access_token_path = Prompt.ask("Enter your Polygon access token path")
